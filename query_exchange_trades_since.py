...
def main():
    ...
    print("Fetching SUI/USDC trades since 2026-06-02 03:13:20 UTC...")
    try:
        # 2026-06-02 03:13:20 UTC in ms epoch: 1780370000000
        trades = ex.fetch_my_trades('SUI/USDC:USDC', since=1780370000000, limit=1000)
