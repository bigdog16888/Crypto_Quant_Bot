...
WHITELIST = [
    ...
    ("engine/database.py",       4471, "flag_pair_ledger_mismatch: isolated startup drift check (gate selected bots)"),
    ("engine/database.py",       4485, "flag_pair_ledger_mismatch: critical startup drift check (gate all bots)"),
