...
WHITELIST = [
    ...
    ("engine/reconciler.py",     6015, "DIRECTIONAL-MISMATCH: physical position contradicts bot direction"),
    ("engine/reconciler.py",     8279, "ADOPT-LIMIT-EXCEEDED: exceeds MAX_ADOPTION_QTY_PER_CYCLE"),
    ("engine/reconciler.py",     8887, "PROOF-FAILED: forensic scan succeeded but gap persists"),
    ("engine/reconciler.py",     8913, "PROOF-FAILED: forensic scan raised exception, gap unresolved"),
