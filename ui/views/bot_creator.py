...
def render_bot_creator_view():
    ...
    with st.form("deploy_bot_form"):
        ...
        with st.expander("Trade Management (Exit & Hedge)", expanded=False):
            ...
            with col_ee3:
                bot_config['EEGracePeriodMins'] = st.number_input("Grace Period (Mins)", value=0.0, min_value=0.0,
                    help="Wait this many minutes before starting the Early Exit decay. Timer resets on every grid hit.")
            with col_ee4:
