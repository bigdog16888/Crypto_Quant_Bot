...
- Ongoing job (Track A, Hermes): RESTARTED 12:29 from 36c119c (O-3 hardening). Engine UP, cycling, O-3 silent, freeze-guard firing, BNB TP re-placed. Watching for: stable 30+ min, first scheduled reconcile cycle, any O-3 'confirmation pending' lines (expected NONE — if one appears, the new formula is reading something transient; investigate immediately).
